...
const routes: Routes = [
  { path: 'login', loadChildren: () => import('./modules/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      { path: 'suppliers', canActivate: [PermissionGuard], data: { anyPermissions: ['SUPPLIER_VIEW', 'SUPPLIER_CREATE', 'SUPPLIER_EDIT'] }, loadChildren: () => import('./modules/suppliers/suppliers.module').then(m => m.SuppliersModule) },
