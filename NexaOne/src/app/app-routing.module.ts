...
const routes: Routes = [
  { path: 'login', loadChildren: () => import('./modules/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      { path: 'products', canActivate: [PermissionGuard], data: { anyPermissions: ['PRODUCT_VIEW', 'PRODUCT_CREATE', 'PRODUCT_EDIT', 'CATEGORY_VIEW', 'BRAND_VIEW', 'UOM_VIEW'] }, loadChildren: () => import('./modules/products/products.module').then(m => m.ProductsModule) },
      { path: 'inventory', canActivate: [PermissionGuard], data: { anyPermissions: ['INVENTORY_VIEW', 'STOCK_ADJUSTMENT_VIEW', 'STOCK_ADJUSTMENT_CREATE', 'TRANSFER_VIEW', 'TRANSFER_CREATE', 'TRANSFER_EDIT'] }, loadChildren: () => import('./modules/inventory/inventory.module').then(m => m.InventoryModule) },
      ...
      { path: 'customers', canActivate: [PermissionGuard], data: { anyPermissions: ['CUSTOMER_VIEW', 'CUSTOMER_CREATE', 'CUSTOMER_EDIT', 'CUSTOMER_AGING_VIEW', 'CUSTOMER_LEDGER_VIEW', 'CUSTOMER_RECEIPT_VIEW', 'CUSTOMER_RECEIPT_CREATE', 'CUSTOMER_RECEIPT_EDIT'] }, loadChildren: () => import('./modules/customers/customers.module').then(m => m.CustomersModule) },
      { path: 'suppliers', canActivate: [PermissionGuard], data: { anyPermissions: ['SUPPLIER_VIEW', 'SUPPLIER_CREATE', 'SUPPLIER_EDIT', 'SUPPLIER_PAYMENT_VIEW', 'SUPPLIER_PAYMENT_CREATE', 'SUPPLIER_PAYMENT_EDIT', 'SUPPLIER_LEDGER_VIEW'] }, loadChildren: () => import('./modules/suppliers/suppliers.module').then(m => m.SuppliersModule) },
